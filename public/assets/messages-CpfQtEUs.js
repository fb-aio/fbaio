import{d as x}from"./dayjs.min-CyBAOehJ.js";import{C as g,D as y,i as D,L as q,P as E,Q as U}from"./MyApp-DK69-3iP.js";const O="YYYY-MM-DD",I=x("2004-01-01",O);async function $({threadId:t="",progressCallback:o,checkStopFn:d}){var a;const e=[],i=await k({threadId:t});if(i.length)for(e.push(...i),o==null||o(e);;)try{const s=(a=e[0])==null?void 0:a.id,r=await M({threadId:t,msgId:s,direction:"up",limit:200});if(r.pop(),!(r!=null&&r.length)||d!=null&&d())break;e.unshift(...r),o==null||o(e),await q(500)}catch(s){console.error(s);break}return e}async function G(){return(await Promise.all([g("viewer(){message_threads{count,nodes{customization_info{emoji,outgoing_bubble_color,participant_customizations{participant_id,nickname}},all_participants{nodes{messaging_actor{name,id,profile_picture}}},thread_type,name,messages_count,image,id}}}").then(e=>y(e||"{}")),g({queries:{o0:{doc_id:"1475048592613093",query_params:{limit:500,before:Date.now(),tags:["ARCHIVED"],includeDeliveryReceipts:!0,includeSeqID:!1}}}},"https://www.facebook.com/api/graphqlbatch/").then(e=>{var i,a,s;return(s=(a=y(((i=e==null?void 0:e.split(`
...
`}export{$ as a,k as b,M as c,P as d,v as f,G as g,I as m,S as s};
